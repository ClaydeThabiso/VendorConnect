...
 Stall allocation
 Payment tracking
 Automated layout & space assignment
It’s essentially an event marketplace with three user roles:
👤 Admin (System Owner) | 🎪 Event Organizer | 🧑🎨 Vendor
👥 User Roles and Dashboards
♂️ 1. Admin (System Owner)
...
 Vendor Assignment: Automatically assign vendors to available spaces.
